    ...
    <section className="py-16 px-8 bg-gray-50">
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
        ...
        <div className="bg-white rounded-xl shadow-xl p-6 transition-transform transform hover:scale-105 hover:shadow-2xl">
          <img src="/learning.svg" alt="Learning" className="w-16 mb-4" />
        ...
        {/* Feature 2: Exam */}
        <div className="bg-white rounded-xl shadow-xl p-6 transition-transform transform hover:scale-105 hover:shadow-2xl">
          <img src="/exam.svg" alt="Exam" className="w-16 mb-4" />
        ...
        {/* Feature 3: Community */}
        <div className="bg-white rounded-xl shadow-xl p-6 transition-transform transform hover:scale-105 hover:shadow-2xl">
          <img src="/community.svg" alt="Community" className="w-16 mb-4" />
        ...
        {/* Feature 4: History */}
        <div className="bg-white rounded-xl shadow-xl p-6 transition-transform transform hover:scale-105 hover:shadow-2xl">
          <img src="/history.svg" alt="History" className="w-16 mb-4" />
        ...
        {/* Feature 5: Feedback */}
        <div className="bg-white rounded-xl shadow-xl p-6 transition-transform transform hover:scale-105 hover:shadow-2xl">
          <img src="/feedback.svg" alt="Feedback" className="w-16 mb-4" />
